...
mod tests {
    ...
    fn test_directory_search_base_object() {
        ...
        // Search for exact DN
        let results = directory.search_entries(
    ...
    fn test_directory_search_with_filter() {
        ...
        entry1.add_attribute(
            "uid".to_string(),
            vec![crate::directory::entry::AttributeValue::String("user1".to_string())],
            crate::directory::entry::AttributeSyntax::String,
        );
        ...
        entry2.add_attribute(
            "uid".to_string(),
            vec![crate::directory::entry::AttributeValue::String("user2".to_string())],
            crate::directory::entry::AttributeSyntax::String,
        );
    ...
    fn test_directory_indexing() {
        ...
        entry.add_attribute(
            "uid".to_string(),
            vec![crate::directory::entry::AttributeValue::String("testuid".to_string())],
            crate::directory::entry::AttributeSyntax::String,
        );
        entry.add_attribute(
            "cn".to_string(),
            vec![crate::directory::entry::AttributeValue::String("Indexed User".to_string())],
            crate::directory::entry::AttributeSyntax::String,
        );
